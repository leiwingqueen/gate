<%@page import="com.elend.p2p.util.SystemConstant"%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
<%@ page import="com.elend.gate.conf.facade.SystemConfig"%>
<%@ page import="com.elend.p2p.spring.SpringContextUtil"%>
...
<%
 	...
 	SystemConfig sysConfig = (SystemConfig) SpringContextUtil.getBean("systemConfig");
 	
 	boolean isTest = sysConfig.isTest();
 	if(isTest) {
	 	request.setAttribute("href", "https://mtest.gzdai.com/mobile/index.html");
 	} else {
	 	request.setAttribute("href", "https://m.gzdai.com/mobile/index.html");
 	}
%>
...
<body>
<div class="error">
  <div class="error-pic"><div class="error-logo"><a class="" href="/">广州e贷首页</a></div>
  <ul>
  <li><c:out value="${error}"/></li>
  <!-- 
  <li><input type="button" class="button" value="返回首页" onclick="javascript:window.location.href='${href}'" /></li>
   -->
  <li><label id="seconds">3</label>&nbsp;秒后自动回到首页 </li>
  <!-- 
    <li>投资就像一场马拉松</li>
