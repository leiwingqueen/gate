package com.elend.gate.channel.util.baofoo;
...
import com.elend.p2p.util.encrypt.Base64;
...
public class SecurityUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(SecurityUtil.MD5("100000178~|~10000001~|~160823094229230010620001~|~1~|~01~|~1~|~20160823094228~|~abcdefg"));
