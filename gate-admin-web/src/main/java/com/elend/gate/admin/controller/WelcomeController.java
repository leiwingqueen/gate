...
import com.elend.gate.admin.helper.MemcacheHelper;
...
public class WelcomeController extends BaseController  {
	...
	public ModelAndView welcome(HttpServletRequest request,HttpServletResponse response) {
		...
		String url = sucEsbHelper.getWelcomeUrl(ReconciliationConstant.app_id, ReconciliationConstant.app_key, auth.getUserName());
