package com.elend.gate.admin.cfg;
 ...
 *
 */
public class GateAdminCommConfig {
	
	private final static Logger logger = LoggerFactory.getLogger(GateAdminCommConfig.class);
	
	/** 默认的配置文件 */
	private static String CONFIG_FILE = "classpath:config/gate-admin-config.xml";
	...
	public static void main(String[] args) {
		try {
			GateAdminCommConfig.init();
			System.out.println(GateAdminCommConfig.get("domain"));
		} catch (Exception e) {
			e.printStackTrace();
		}
