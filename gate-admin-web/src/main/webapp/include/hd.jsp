...
<head>
	<meta charset="utf-8" />
	<title id="PAGETITLE">支付订单管理后台</title>
	...
	<div class="header navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<!-- BEGIN LOGO -->
				<a class="brand" href="/"> <img width="30" height="30" src="http://static.gzdai.com/sysop_fed_lib/assets/img/ico.png" alt="logo" /> <span class="font-small">结算系统</span> </a>
				<!-- END LOGO -->
				<!-- BEGIN 响应式时 菜单按钮 -->
