				...
				<form id="fm" class="form form-horizontal">
					<!-- BEGIN 查询条件 -->
				 	...
				 	<div class="control-group">
				 		...
				 		<input id="partnerOrderId" name="partnerOrderId" class="" type="text" />
				 	</div>
				 	<div class="control-group">
				...
				<div class="portlet-body" >
					...
					<tbody id="tbody" ms-controller="dataList">
						<tr ms-repeat-item="list">
							...
							<td>
								<a ms-if="item.status == 1" class="btn green btn-primary" ms-click="sync(item.orderId)">同步</a>
							</td>
						</tr>
					</tbody>
					</table>
...
<script src="/js/payOrder/withdrawRequestList.js"></script>
<!-- END 页面基本js -->
